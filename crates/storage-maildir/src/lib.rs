...
mod flags;
// Flat re-export: the split is where the code lives, not what it is
// called. Every caller — in this workspace and on crates.io — keeps
// `mailrs_maildir::Flag` and `mailrs_maildir::parse_flags`.
pub use flags::*;
