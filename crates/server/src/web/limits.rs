//! The request-shape limits every handler clamps against, and the
//! two result aliases.
...
pub(crate) const MAX_OFFSET: u32 = 1_000_000;

/// maximum length for search query strings
pub(crate) const MAX_QUERY_LEN: usize = 500;
...
pub(crate) const MAX_MULTIPART_BODY: usize = 25 * 1024 * 1024;
...
pub(crate) const MAX_SIEVE_SCRIPT_LEN: usize = 64 * 1024;
