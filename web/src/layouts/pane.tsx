...
export const MPane = forwardRef<HTMLDivElement, PaneProps>(function MPane(
  ...
  return (
    <Pane
      className={cx(
        'bg-surface flex flex-col overflow-hidden md:rounded-lg',
        className
      )}
      ref={ref}
      {...props}
...
export const MPaneGroup = forwardRef<HTMLDivElement, PaneGroupProps>(
  function MPaneGroup({ className, ...props }, ref) {
    return (
      <PaneGroup
        className={cx('gap-0 md:gap-1.5', className)}
        ref={ref}
        {...props}
      />
    )
