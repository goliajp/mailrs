...
export function ContactAutocomplete({
  ...
  return (
    <div ref={containerRef} className="relative flex-1">
      ...
      />
      {showSuggestions && (
        <div className="absolute left-0 top-full z-10 mt-1 w-full min-w-48 max-w-72 rounded-lg border border-[var(--color-border-default)] bg-[var(--color-bg-raised)]" style={{ boxShadow: 'var(--shadow-lg)' }}>
          {suggestions.map((s, i) => (
            <button
              key={s}
