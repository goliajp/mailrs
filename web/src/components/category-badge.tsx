...
export function CategoryBadge({ category }: { category: string }) {
  ...
  return (
    <span className={`inline-flex select-none items-center rounded-full px-1.5 py-0.5 text-[11px] font-medium capitalize ${s.bg} ${s.text}`}>
      {s.label}
    </span>
  )
}
...
export function ImportanceBadge({ level }: { level: string }) {
  ...
  return (
    <span className={`inline-flex select-none items-center gap-0.5 rounded-full px-1.5 py-0.5 text-[11px] font-medium ${s.bg} ${s.text}`}>
...
export function ActionBadge() {
  return (
    <span className="inline-flex select-none items-center gap-0.5 rounded-full bg-purple-100 px-1.5 py-0.5 text-[11px] font-medium text-purple-700 dark:bg-purple-900/30 dark:text-purple-400">
      Action
    </span>
  )
}
