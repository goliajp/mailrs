const styles: Record<string, { bg: string; text: string; label: string }> = {
  ...
  promotion: { bg: 'bg-[var(--color-status-warning-subtle)]', text: 'text-[var(--color-status-warning)]', label: 'Promotion' },
  newsletter: { bg: 'bg-[var(--color-status-danger-subtle)]', text: 'text-[var(--color-status-danger)]', label: 'Newsletter' },
  receipt: { bg: 'bg-[var(--color-status-success-subtle)]', text: 'text-[var(--color-status-success)]', label: 'Receipt' },
  shipping: { bg: 'bg-[var(--color-status-info-subtle)]', text: 'text-[var(--color-status-info)]', label: 'Shipping' },
  travel: { bg: 'bg-[var(--color-status-info-subtle)]', text: 'text-[var(--color-status-info)]', label: 'Travel' },
  finance: { bg: 'bg-[var(--color-status-warning-subtle)]', text: 'text-[var(--color-status-warning)]', label: 'Finance' },
  work: { bg: 'bg-[var(--color-brand-subtle)]', text: 'text-[var(--color-brand-primary)]', label: 'Work' },
  spam: { bg: 'bg-[var(--color-status-warning-subtle)]', text: 'text-[var(--color-status-warning)]', label: 'Spam' },
...
const importanceStyles: Record<string, { bg: string; text: string; label: string; icon: string }> = {
  ...
  important: { bg: 'bg-[var(--color-status-warning-subtle)]', text: 'text-[var(--color-status-warning)]', label: 'Important', icon: '!' },
  ...
  noise: { bg: 'bg-[var(--color-bg-sunken)]', text: 'text-[var(--color-text-tertiary)]', label: 'Noise', icon: '' },
}
...
export function IntentBadge({ intent }: { intent: string }) {
  ...
  const intentStyles: Record<string, { bg: string; text: string }> = {
    ...
    confirm: { bg: 'bg-[var(--color-status-success-subtle)]', text: 'text-[var(--color-status-success)]' },
