    ...
    <div className="border-b border-[var(--color-border-default)] py-4">
      ...
      <div className="rounded-lg border border-[var(--color-border-default)] bg-white">
        {msg.html_body ? (
          ...
          <pre className="max-h-96 overflow-auto whitespace-pre-wrap p-3 text-sm text-[var(--color-text-secondary)]">
            {msg.text_body}
          </pre>
        ) : (
          <p className="p-3 text-sm text-[var(--color-text-tertiary)]">(no content)</p>
        )}
      </div>
        ...
        <div className="mb-4 flex items-center gap-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full rounded-lg border border-[var(--color-border-default)] bg-[var(--color-bg-primary)] py-2 pl-9 pr-3 text-sm outline-none focus:border-[var(--color-border-focus)]"
            />
          </div>
        </div>
